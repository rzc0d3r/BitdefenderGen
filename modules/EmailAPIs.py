...
class DeveloperMailAPI(object):
    ...
    def __parse_message(self, raw_message_body):
        ...
        for part in msg.walk(): # message body filtering, leaves only html code
            content_type = part.get_content_type()
            if content_type == "text/html":
                message_body = part.get_payload(decode=True).decode(part.get_content_charset()) # decoding MIME-Type
                break
